...
<section class="content">
  <div class="row">
    <div class="col-xs-12">
      <div class="box">  
        <div class="col col-xs-16 text-center" id="button-relative">
          <a class="btn btn-sm btn-danger" data-toggle="modal" data-target="#modal-add"> Tambah Pelanggaran</a> 
        </div>
            <!-- /.box-header -->
            ...
            <?php 
              ...
              foreach ($data as $y) { ?>                               
               <tr>
                ...
                <a data-toggle="modal" onclick="delete_confirm('<?php echo site_url('main/peristiwa/hapus_pelanggaran/'.$y->id_peristiwa) ?>')" ><em class="fa fa-trash btn btn-sm btn-danger"></em></a>
                </td><?php }?>
              </tr>
            </tbody>
          </table>
    ...
    <div class="modal fade" id="modal-add" >
      <div class="modal-dialog">
        <form action="<?php echo base_url(). 'main/peristiwa/simpan_pelanggaran'; ?>"  method="post">
  ...
  <div class="modal fade" id="modal-edit<?php echo $y->id_peristiwa?>">
    <div class="modal-dialog">
      <form action="<?php echo base_url(). 'main/peristiwa/update_pelanggaran'; ?>"  method="post">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span></button>
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label name="kategori">Kategori</label>
                <select class='form-control input-md' name='kategori' id='kategori' >
                  <option value=<?php echo $y->id_kategori?> selected hidden><?php echo $y->nama_kategori?></option>
                  <?php
                  foreach ($pelanggaran as $row) {
                    echo '<option value='.$row->id_kategori.'>'.$row->nama_kategori.'</option>';
                  }
